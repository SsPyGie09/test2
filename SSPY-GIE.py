...
➥ GitHub User : 𝗦𝘀𝗣𝘆𝗚𝗶𝗲𝟬𝟵

➥ YouTube : 【 𝗦𝗦𝗣𝗬-𝗚𝗜𝗘 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 】
...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://www.facebook.com/regiemontemayor.09")
                        qsbuy()
...
class crack_main():
        ...
        def crackmail(self,id):
                ...
                user=[]
                print(" [*] First Name Example Regie,Gie")
        ...
        def cracknum(self,id):
                global methods
                os.system('clear');print(logo);xchker()
                print('\033[0mFor Example :\033[0m 0945, 0932, 0966, 0948 ...')
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/SSPY-GIE.txt \033[0;97m\n')
        #100010138361148
...
def double():
        ...
        try:
                ...
                print(' \n\033[1;97mExample: /sdcard/SSPY-GIE.txt\n\033[0;97m')
